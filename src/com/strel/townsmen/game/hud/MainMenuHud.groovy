 ...
 */
class MainMenuHud implements Playable {
    ...
    void draw(Graphics2D g) {
        ...
        g.drawImage(GameConfig.IMG_MAIN_MENU_BACKGROUND, 0, 0, game.wndWidth(), game.wndHeight(), null)
        g.drawImage(GameConfig.IMG_HUD_MAIN_MENU, 30, 10, game.wndWidth() - 60, game.wndHeight() - 20, null)
    }
}
